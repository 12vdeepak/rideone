...
class DispatchController extends Controller
{
    ...
    public function create()
    {
        ...
        $button = $auth_user->can('riderequest list') ? '<a href="'.route('riderequest.index').'" class="float-right btn border-radius-10 btn-dark">'.__('message.list_form_title',['form' => __('message.riderequest')]).'</a>' : '';
