            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height wave wave-animate-slow wave-primary border">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-white">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height wave wave-animate-slow wave-danger border">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-white">
                                        <svg class="svg-icon svg-danger" width="40" height="40" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height wave wave-animate-slow wave-success border">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-white">
                                        <svg class="svg-icon svg-danger" width="40" height="40" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height wave wave-animate-slow wave-info border">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-white">
                                        <svg class="svg-icon svg-danger" width="40" height="40" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
