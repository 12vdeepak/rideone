                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                ...
                                <p class="mb-0">{{ maskSensitiveInfo('contact_number', optional($data->rider)->contact_number) }}</p>
                                <p class="mb-0">{{ maskSensitiveInfo('email', optional($data->rider)->email) }}</p>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                ...
                                <p class="mb-0">{{ maskSensitiveInfo('contact_number', optional($data->driver)->contact_number) }}</p>
                                <p class="mb-0">{{ maskSensitiveInfo('email', optional($data->driver)->email) }}</p>
