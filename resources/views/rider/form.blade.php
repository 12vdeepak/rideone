            ...
            <div class="col-xl-3 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="form-label">{{ __('message.wallet') }}</label>
                            <div class="grid" style="--bs-gap: 1rem">
                                <div class="form-check g-col-6">
                                    {{ Form::radio('wallet', 'Active' , old('wallet') || true, ['class' => 'form-check-input', 'id' => 'wallet-active' ]) }}
                                    {{ Form::label('wallet-active', __('message.active'), ['class' => 'form-check-label' ]) }}
                                </div>
                                <div class="form-check g-col-6">
                                    {{ Form::radio('wallet', 'InActive', old('wallet') , ['class' => 'form-check-input', 'id' => 'wallet-InActive' ]) }}
                                    {{ Form::label('wallet-InActive', __('message.inactive'), ['class' => 'form-check-label' ]) }}
                                </div>
                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{ __('message.rewards') }}</label>
                            <div class="grid" style="--bs-gap: 1rem">
                                <div class="form-check g-col-6">
                                    {{ Form::radio('rewards', 'Active' , old('rewards') || true, ['class' => 'form-check-input', 'id' => 'rewards-active' ]) }}
                                    {{ Form::label('rewards-active', __('message.active'), ['class' => 'form-check-label' ]) }}
                                </div>
                                <div class="form-check g-col-6">
                                    {{ Form::radio('rewards', 'InActive', old('rewards') , ['class' => 'form-check-input', 'id' => 'rewards-InActive' ]) }}
                                    {{ Form::label('rewards-InActive', __('message.inactive'), ['class' => 'form-check-label' ]) }}
                                </div>
