                            ...
                            @else
                                @hasanyrole('admin|demo_admin')
                                    ...
                                    <li class="nav-item">
                                     ...
                                     <li class="nav-item">
                                        <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=reward-setting" data-target=".paste_here" class="nav-link {{$page=='reward-setting'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('message.reward_settings') }}</a>
                                    </li> 
                                    <li class="nav-item">
