...
Route::group(['middleware' => ['auth', 'verified', 'admin']], function () {
    ...
    Route::get('/reward-activation', [HomeController::class, 'rewardActivation'])->name('admin.rewardActivation');
    ...
    Route::get('riderequest/{id}/cancel', [RideRequestController::class, 'cancel'])->name('riderequest.cancel');
    Route::get('riderequest/{id}/change-status', [RideRequestController::class, 'changeStatus'])->name('riderequest.changeStatus');
    ...
    Route::post('reward-settings/save', [SettingController::class, 'rewardSettingsUpdate'])->name('rewardSettingsUpdate');
    ...
    Route::post('save-rewards-fund/{user_id}', [HomeController::class, 'saveRewards'])->name('saveRewards.fund');
    Route::get('changestatus/{id}', [RewardController::class, 'changeStatus'])->name('Rewards.changeStatus');
