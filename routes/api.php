...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('reward-activation', [ API\WalletController::class, 'rewardActivation']);
    ...
    Route::get('rewards', [ API\WalletController::class, 'getRewards'] );
    Route::get('wallet-order', [ API\WalletController::class, 'walletActive'] );
